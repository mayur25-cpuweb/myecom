...
function SareeWear() {
        ...
        const [swsubcatproduct, setswsubcatproduct] = useState([]);
 ...
 var productlistsw=swproduct.map((pl)=>{
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist" style={{justifyContent:'center'}}>
    ...
    <button class="nav-link" id="nav-td-tab" data-bs-toggle="tab" data-bs-target="#nav-td" type="button" role="tab" aria-controls="nav-td" aria-selected="false">Tie & Die Saree</button>
    <button class="nav-link" id="nav-hs-tab" data-bs-toggle="tab" data-bs-target="#nav-hs" type="button" role="tab" aria-controls="nav-hs" aria-selected="false">Handpainted Saree</button>
    <button class="nav-link" id="nav-kz-tab" data-bs-toggle="tab" data-bs-target="#nav-kz" type="button" role="tab" aria-controls="nav-kz" aria-selected="false">Kota zariya Saree(Exclusive)</button>
...
<div class="tab-content" id="nav-tabContent">
  ...
  {swproduct.filter(plist => plist.subcat == "Tie&DieSaree").map(pl => (
    <Link exact to={`/productdetail/${pl._id}`}>
        <div data-aos="zoom-in"><p>{pl.category}</p>
    {/* <Link exact to={`/productdetail/${pl._id}`}> */}
        <div className="col" key={pl._id}>
...
{swproduct.filter(plist => plist.subcat == "Handpainted Saree").map(pl => (
  <Link exact to={`/productdetail/${pl._id}`}>
      <div data-aos="zoom-in"><p>{pl.category}</p>
  {/* <Link exact to={`/productdetail/${pl._id}`}> */}
      <div className="col" key={pl._id}>
...
{swproduct.filter(plist => plist.subcat =="Kota zariya").map(pl => (
  <Link exact to={`/productdetail/${pl._id}`}>
      <div data-aos="zoom-in"><p>{pl.category}</p>
  {/* <Link exact to={`/productdetail/${pl._id}`}> */}
      <div className="col" key={pl._id}>
